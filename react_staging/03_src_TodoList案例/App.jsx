...
//此案例的准备工作。
//1.从静态文件里把整个html结构复制到App.jsx里（然后在慢慢拆成组件）。由于静态文件中的html也用到了id=root的div，需要double-check一下css里有没有使用root定义的样式。
...
export default class App extends Component {
	...
	//Header会在合适的时候，调用“当年”App传给他的addTod函数，通过该函数把todoObj交给了App
